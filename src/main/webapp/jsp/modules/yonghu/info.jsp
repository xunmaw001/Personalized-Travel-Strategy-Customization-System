...
<body>
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group  col-md-12">
										<label>兴趣爱好</label>
										<script id="xingquaihaoEditor" type="text/plain" style="width:800px;height:230px;"></script>
										<script type="text/javascript">
										    //建议使用工厂方法getEditor创建和引用编辑器实例，如果在某个闭包下引用该编辑器，直接调用UE.getEditor('editor')就能拿到相关的实例
										   //相见文档配置属于你自己的编译器
										 var xingquaihaoUe = UE.getEditor('xingquaihaoEditor', {
											toolbars: [
													[
														'undo', //撤销
														'bold', //加粗
										...
										<input type="hidden" name="xingquaihao" id="xingquaihao-input">
									</div>
	...
	<script>
		...
		// 填充富文本框
		function setContent(){
			if(ruleForm.xingquaihao != null && ruleForm.xingquaihao != 'null' && ruleForm.xingquaihao != ''){
				var mes = '' + ruleForm.xingquaihao;
				var xingquaihaoUeditor = UE.getEditor('xingquaihaoEditor');
				xingquaihaoUeditor.ready(function() {
					xingquaihaoUeditor.setContent(mes);
					xingquaihaoUeditor.setDisabled('fullscreen');
				});
			}
		}  

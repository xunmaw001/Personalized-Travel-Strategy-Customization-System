...
<body>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var xingquaihaoCell  = document.createElement('td');

						  if(item.xingquaihao != null && item.xingquaihao != "" && item.xingquaihao.length >= 11){
			  	xingquaihaoCell.innerHTML = item.xingquaihao.substring(0, 10) + "..."; 
			  }else{
			  	xingquaihaoCell.innerHTML = item.xingquaihao;
			  }


			row.appendChild(xingquaihaoCell);

...
<body>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>兴趣爱好</label>
										<textarea name="xingquaihao" class="form-control" id="xingquaihao" rows="3"></textarea>
									</div>
									<div class="form-group col-md-6">
										<label>图片</label>
	...
	<script>
		...
		function dataBind(){
			...
			$("#xingquaihao").val(ruleForm.xingquaihao);
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.xingquaihao != null && res.data.xingquaihao != ''){

					$("#xingquaihao").val(res.data.xingquaihao);
					}

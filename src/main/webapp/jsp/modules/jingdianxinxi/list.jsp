...
<body>
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('menpiaoleixing')">门票类型<i id="menpiaoleixingIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var menpiaoleixingCell  = document.createElement('td');

						 menpiaoleixingCell.innerHTML = item.menpiaoleixing;

			row.appendChild(menpiaoleixingCell);
			...
			var jingdiangonglveCell  = document.createElement('td');
			...
			var crossBtn0 = document.createElement('button');
            		crossBtn0.innerHTML = "项目信息"
			crossBtn0.setAttribute("type","button");
			crossBtn0.setAttribute("class","btn btn-primary btn-sm");
			crossBtn0.setAttribute("onclick","crossTable(" + JSON.stringify(item) + ",'jingdianxiangmu','','','')");
			if(crossBtnControl('项目信息') == true){

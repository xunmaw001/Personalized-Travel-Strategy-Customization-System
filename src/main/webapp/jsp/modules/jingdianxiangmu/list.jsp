...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">景点项目管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>景点项目列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">景点项目列表</h3>							
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('xiangmujiage')">项目价格<i id="xiangmujiageIcon" class="fa fa-sort"></i></th>
											<th>项目图片</th>
											<th>操作</th>
										</tr>
									</thead>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var xiangmujiageCell  = document.createElement('td');

						 xiangmujiageCell.innerHTML = item.xiangmujiage;

			row.appendChild(xiangmujiageCell);
			var xiangmujieshaoCell  = document.createElement('td');

			
			var xiangmutupianCell  = document.createElement('td');

				                var xiangmutupianImg = document.createElement('img');
			xiangmutupianImg.setAttribute('src',baseUrl+item.xiangmutupian);
			xiangmutupianImg.setAttribute('height',100);
			xiangmutupianImg.setAttribute('width',100);
			xiangmutupianCell.appendChild(xiangmutupianImg);


			row.appendChild(xiangmutupianCell);
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("jingdianxiangmu/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
	...
	function discussList(id) {
            ...
            window.location.href = "../discussjingdianxiangmu/list.jsp"
        }
		//清除会重复渲染的节点
        function clear(){
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"jingdianxiangmu");

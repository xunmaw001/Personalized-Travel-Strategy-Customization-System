	...
	<body>
		...
		<div id="app">
			...
			<div class="data-add-container" :style='{"padding":"20px","boxShadow":"1px 1px 6px rgba(110,22,64,0)","margin":"30px auto","borderColor":"rgba(156, 187, 252, 1)","backgroundColor":"#fff","borderRadius":"10px","borderWidth":"1px","borderStyle":"solid"}'>
				...
				<form class="layui-form layui-form-pane add" lay-filter="myForm">
		            ...
		            <div :style='{"padding":"10px","boxShadow":"0 0 6px rgba(110,22,64,0)","margin":"0 0 10px 0","borderColor":"rgba(156, 187, 252, 1)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"0 0 3px 0","borderStyle":"dotted"}' class="layui-form-item" pane>
		                <label :style='{"width":"94px","padding":"0 12px 0 0","fontSize":"14px","color":"#333","textAlign":"right"}' class="layui-form-label">门票类型</label>
		                <div class="layui-input-block">
		                    <select name="menpiaoleixing" id="menpiaoleixing" lay-filter="menpiaoleixing"  >
		                        <option value="">请选择</option>
		                        <option v-for="(item,index) in menpiaoleixing" v-bind:key="index" :value="item">{{item}}</option>
		                    </select>
		                </div>
		            </div>
		            <div :style='{"padding":"10px","boxShadow":"0 0 6px rgba(110,22,64,0)","margin":"0 0 10px 0","borderColor":"rgba(156, 187, 252, 1)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"0 0 3px 0","borderStyle":"dotted"}' class="layui-form-item" pane>
						...
						<div class="layui-input-block">
							<input :style='{"padding":"0 12px","boxShadow":"0 0 6px rgba(110,22,64,0)","borderColor":"rgba(156, 187, 252, 1)","backgroundColor":"#fff","color":"#333","borderRadius":"4px","textAlign":"left","borderWidth":"1px","fontSize":"14px","borderStyle":"solid","height":"40px"}' v-model="detail.jingdiandianhua" type="text" :readonly="ro.jingdiandianhua" name="jingdiandianhua" id="jingdiandianhua" autocomplete="off" class="layui-input">
						</div>
					</div>
		            <div :style='{"padding":"10px","boxShadow":"0 0 6px rgba(110,22,64,0)","margin":"0 0 10px 0","borderColor":"rgba(156, 187, 252, 1)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"0 0 3px 0","borderStyle":"dotted"}' class="layui-form-item" pane>
						<label :style='{"width":"94px","padding":"0 12px 0 0","fontSize":"14px","color":"#333","textAlign":"right"}' class="layui-form-label">景点图片：</label>
						<div v-if="detail.jingdiantupian" class="layui-input-block">
							...
							<input :style='{"padding":"0 12px","boxShadow":"0 0 6px rgba(110,22,64,0)","borderColor":"rgba(156, 187, 252, 1)","backgroundColor":"#fff","color":"#333","borderRadius":"4px","textAlign":"left","borderWidth":"1px","fontSize":"14px","borderStyle":"solid","height":"40px"}' type="hidden" :value="detail.jingdiantupian" id="jingdiantupian" name="jingdiantupian" />
						</div>
						<div class="layui-input-block">
		            ...
		            <div :style='{"padding":"10px","boxShadow":"0 0 6px rgba(110,22,64,0)","margin":"0 0 10px 0","borderColor":"rgba(156, 187, 252, 1)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"0 0 3px 0","borderStyle":"dotted"}' class="layui-form-item" pane>
						<label :style='{"width":"94px","padding":"0 12px 0 0","fontSize":"14px","color":"#333","textAlign":"right"}' class="layui-form-label">景点攻略：</label>
						<div class="layui-input-block">
							<textarea name="jingdiangonglve" id="jingdiangonglve">请输入景点攻略</textarea>
						</div>
					</div>
		...
		<script>
			...
			var vue = new Vue({
				...
				data: {
					...
					ro:{
                                        ...
                                        jingdiandianhua : false,
                                        jingdiangonglve : false,
			...
			layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate','tinymce'], function() {
                ...
                form.on('select(menpiaoleixing)', function (data) {
                    vue.detail.menpiaoleixing=data.value;
                });
                var edit = tinymce.render({
                    elem: "#jingdiangonglve",
                    height: 600,
                ...
                if(http.getParam('corss')){
					...
					for(var o in obj){
                                        ...
                                        if(o=='menpiaoleixing'){
                                                vue.detail[o] = obj[o];
                                                vue.ro.menpiaoleixing = true;
                                                continue;
                                        }
                                        if(o=='jingdiandianhua'){
                                                vue.detail[o] = obj[o];
                                                vue.ro.jingdiandianhua = true;
                                                continue;
                                        }
                                        if(o=='jingdiangonglve'){
                                                vue.detail[o] = obj[o];
                                                vue.ro.jingdiangonglve = true;
                                                continue;
                                        }
                                        if(o=='jingdiantupian'){
                                                vue.detail[o] = obj[o];
				...
				form.on('submit(*)', function(data) {
					...
					var jingdiangonglve = tinymce.get('#jingdiangonglve').getContent()
					data.jingdiangonglve = jingdiangonglve;
